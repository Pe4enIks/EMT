...
from basicsr.utils import get_root_logger, img2tensor, imwrite, tensor2img
...
class IRModel(_BaseModel):
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        if with_metrics:
            ...
            # initialize the best metric results for each dataset_name
            # (supporting multiple validation datasets)
        ...
        for idx, val_data in enumerate(dataloader):
            ...
            if self.bit == 0:
                ...
                sr_img = tensor2img(
                    img2tensor(cv2.imread(temp_img_path) / (2**self.bit - 1.0))
                )  # noqa
                metric_data["img"] = sr_img
                if "gt" in visuals:
                    gt_img = (
